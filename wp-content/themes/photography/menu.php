    ...
    <div class="jumbotron-inner">
      ...
      <div class="wrapper menu-wrapper">
        ...
        <div class="menu-outer">
          <ul class="menu-inner">
            ...
            <li class="menu-item"><a href="http://amandaleaphotography.com/#contact-section">Contact</a></li>
      ...
      <div class="mobile-menu-dropdown expand">
        <ul class="mobile-menu-inner">
          ...
          <li class="mobile-menu-item"><a href="http://amandaleaphotography.com/#contact-section">Contact</a></li>
